 ...
 */
function testResult(dataWordNumber) {
    dataWordNumber++;
 ...
 * Takes the word count from dataWordNumber
 ...
 */
function createRow(dataWordNumber) {
    ...
    let data2 = document.createTextNode(dataWordNumber);
 ...
 * If no number entered the user will be prompted to use a number in each field */
function calculator() {
    ...
    let percentage = Math.round(increase);
